  ...
  return (
    <div ref={scrollRef} className=" grid grid-cols-simple2 w-[100vw] overflow-hidden pb-[100px] pt-[20px] ">
      <div className={`w-screen transition-all ease-in-out duration-1000 ${!active ? 'right-0' : 'right-[100vw]'}  pr-[50px] first-screen relative`}>
        <div className='flex flex-row justify-between h-full'>
          ...
          <div className="relative flex flex-col items-start justify-between">
            ...
            <div className={`relative ml-auto mt-[20px] ${!active ? 'bottom-0' : 'bottom-[-200px]'} duration-1000 ease-in-out transition-all right-0`}>
              <p className="mb-[20px] text-white font-medium font-main text-[20px]">Листай<br></br>дальше</p>
        ...
        <div className="text-white leading-[100px] text-[90px] font-main font-medium absolute left-[50px] top-[50%] translate-y-[-50%] ">
          <p>Баланс металла</p>
      ...
      <div className={`${active ? 'right-[100vw]' : 'right-0'} ease-in-out transition-all duration-1000 relative w-screen first-screen flex flex-row justify-between pl-[50px] pr-[62px] `}>
          <div className={` ${active ? 'left-0' : 'left-[50px]' } relative duration-1000 transition-all ease-in-out flex justify-center items-center opacity-50`}>
